...
const EPD_WP_ED047TC2_1_5_DATA: [[[u8; 4]; 16]; 25] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_6_DATA: [[[u8; 4]; 16]; 22] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_7_DATA: [[[u8; 4]; 16]; 22] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_8_DATA: [[[u8; 4]; 16]; 22] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_9_DATA: [[[u8; 4]; 16]; 18] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_10_DATA: [[[u8; 4]; 16]; 17] = [
    [
        [0x00, 0x00, 0x00, 0x01],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_1_11_DATA: [[[u8; 4]; 16]; 15] = [
    [
        [0x00, 0x00, 0x00, 0x55],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_5_DATA: [[[u8; 4]; 16]; 46] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x20, 0x88, 0xaa, 0x02],
        [0x00, 0x08, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_6_DATA: [[[u8; 4]; 16]; 43] = [
    [
        [0x02, 0xaa, 0x00, 0x00],
        [0x20, 0x22, 0xa8, 0x80],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_7_DATA: [[[u8; 4]; 16]; 40] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_8_DATA: [[[u8; 4]; 16]; 38] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x08, 0x00, 0x8a, 0x02],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_9_DATA: [[[u8; 4]; 16]; 38] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x0a, 0x82, 0x02, 0x00],
        [0x40, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_10_DATA: [[[u8; 4]; 16]; 44] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x80, 0x80, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_2_11_DATA: [[[u8; 4]; 16]; 57] = [
    [
        [0x20, 0x8a, 0x80, 0x00],
        [0x15, 0x55, 0x5a, 0xa4],
        [0x44, 0x10, 0x0a, 0x41],
...
const EPD_WP_ED047TC2_5_5_DATA: [[[u8; 4]; 16]; 46] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x20, 0x88, 0xaa, 0x02],
        [0x00, 0x08, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_6_DATA: [[[u8; 4]; 16]; 43] = [
    [
        [0x02, 0xaa, 0x00, 0x00],
        [0x20, 0x22, 0xa8, 0x80],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_7_DATA: [[[u8; 4]; 16]; 40] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_8_DATA: [[[u8; 4]; 16]; 38] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x08, 0x00, 0x8a, 0x02],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_9_DATA: [[[u8; 4]; 16]; 38] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x0a, 0x82, 0x02, 0x00],
        [0x40, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_10_DATA: [[[u8; 4]; 16]; 44] = [
    [
        [0x00, 0x00, 0x00, 0x00],
        [0x80, 0x80, 0x00, 0x00],
        [0x00, 0x00, 0x00, 0x00],
...
const EPD_WP_ED047TC2_5_11_DATA: [[[u8; 4]; 16]; 57] = [
    [
        [0x20, 0x8a, 0x80, 0x00],
        [0x15, 0x55, 0x5a, 0xa4],
        [0x44, 0x10, 0x0a, 0x41],
